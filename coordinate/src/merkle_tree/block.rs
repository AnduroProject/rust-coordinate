...
//!
//! ```rust
//! use coordinate::hash_types::Txid;
//! use coordinate::hex::FromHex;
//! use coordinate::{Block, MerkleBlock};
//!
...
//! let mb: MerkleBlock = coordinate::consensus::deserialize(&mb_bytes).unwrap();
//!
...
impl MerkleBlock {
    ...
    /// let block: Block = coordinate::consensus::deserialize(&block_bytes).unwrap();
    ///
...
impl PartialMerkleTree {
    ...
    /// use coordinate::hash_types::Txid;
    /// use coordinate::hex::FromHex;
    /// use coordinate::merkle_tree::{MerkleBlock, PartialMerkleTree};
    ///
    /// // Block 80000
    /// let txids: Vec<Txid> = [
