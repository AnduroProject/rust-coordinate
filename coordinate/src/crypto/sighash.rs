...
impl<E> EncodeSigningDataResult<E> {
    ...
    ///
    /// ```rust
    /// # use coordinate::consensus::deserialize;
    /// # use coordinate::hashes::{Hash, hex::FromHex};
    /// # use coordinate::sighash::{LegacySighash, SighashCache};
    /// # use coordinate::Transaction;
    /// # let mut writer = LegacySighash::engine();
    /// # let input_index = 0;
    /// # let script_pubkey = coordinate::ScriptBuf::new();
