...
//! use coordinate::{Address, PublicKey, Network};
//! use coordinate::secp256k1::{rand, Secp256k1};
//!
...
/// ```rust
/// use std::str::FromStr;
/// use coordinate::{Address, Network};
/// use coordinate::address::{NetworkUnchecked, NetworkChecked};
///
/// // variant 1
...
/// ```
/// # use std::str::FromStr;
/// # use coordinate::address::{Address, NetworkChecked};
...
/// ```
/// # use std::str::FromStr;
/// # use coordinate::address::{Address, NetworkUnchecked};
/// let address: Address<NetworkUnchecked> = Address::from_str("132F25rTsvBdp9JzLLBHP5mvGY66i1xdiM")
///                .unwrap();
...
impl Address {
    ...
    /// # let address = ADDRESS.parse::<coordinate::Address<_>>().unwrap().assume_checked();
...
impl Address<NetworkUnchecked> {
    ...
    /// ```rust
    /// use coordinate::{Address, Network};
    /// use coordinate::address::NetworkUnchecked;
    ///
    ...
    ///
    /// ```
    /// use coordinate::address::{NetworkChecked, NetworkUnchecked, ParseError};
    /// use coordinate::{Address, Network};
    ///
