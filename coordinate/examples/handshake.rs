...
use coordinate::consensus::{encode, Decodable};
use coordinate::p2p::{self, address, message, message_network};
use coordinate::secp256k1::rand::Rng;
...
fn main() {
    ...
    let first_message =
        message::RawNetworkMessage::new(coordinate::Network::Bitcoin.magic(), version_message);
            ...
            match reply.payload() {
                message::NetworkMessage::Version(_) => {
                    ...
                    let second_message = message::RawNetworkMessage::new(
                        coordinate::Network::Bitcoin.magic(),
