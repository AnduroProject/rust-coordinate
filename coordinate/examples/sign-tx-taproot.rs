...
use coordinate::key::{Keypair, TapTweak, TweakedKeypair, UntweakedPublicKey};
use coordinate::locktime::absolute;
use coordinate::secp256k1::{rand, Message, Secp256k1, SecretKey, Signing, Verification};
use coordinate::sighash::{Prevouts, SighashCache, TapSighashType};
use coordinate::{
...
fn main() {
    ...
    let signature = coordinate::taproot::Signature { signature, sighash_type };
