...
use coordinate::secp256k1::{rand, Message, Secp256k1, SecretKey, Signing};
use coordinate::sighash::{EcdsaSighashType, SighashCache};
use coordinate::{
...
fn main() {
    ...
    let signature = coordinate::ecdsa::Signature { signature, sighash_type };
...
fn senders_keys<C: Signing>(secp: &Secp256k1<C>) -> (SecretKey, WPubkeyHash) {
    ...
    let pk = coordinate::PublicKey::new(sk.public_key(secp));
