...
use coordinate::bip32::{DerivationPath, Fingerprint};
use coordinate::consensus::encode::serialize_hex;
use coordinate::opcodes::all::OP_CHECKSIG;
use coordinate::psbt::{GetKey, Input, KeyRequest, PsbtSighashType, SignError};
use coordinate::taproot::{LeafVersion, TaprootBuilder, TaprootSpendInfo};
use coordinate::transaction::Version;
use coordinate::{
