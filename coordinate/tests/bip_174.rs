...
use coordinate::bip32::{Fingerprint, IntoDerivationPath, KeySource, Xpriv, Xpub};
use coordinate::blockdata::opcodes::OP_0;
use coordinate::blockdata::{script, transaction};
use coordinate::consensus::encode::{deserialize, serialize_hex};
use coordinate::hex::FromHex;
use coordinate::psbt::{Psbt, PsbtSighashType};
use coordinate::script::PushBytes;
use coordinate::secp256k1::Secp256k1;
use coordinate::{
...
#[track_caller]
fn signer_one_sign(psbt: Psbt, key_map: BTreeMap<coordinate::PublicKey, PrivateKey>) -> Psbt {
...
#[track_caller]
fn signer_two_sign(psbt: Psbt, key_map: BTreeMap<coordinate::PublicKey, PrivateKey>) -> Psbt {
...
fn sign(mut psbt: Psbt, keys: BTreeMap<coordinate::PublicKey, PrivateKey>) -> Psbt {
    let secp = Secp256k1::new();
